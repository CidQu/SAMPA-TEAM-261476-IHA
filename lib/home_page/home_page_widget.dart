                            ...
                            child: Column(
                              ...
                              children: [
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Lise Öğrencileri İnsansız Hava Araçları Yarışması',
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Son uçuş içerisinde gerçekleşen ölçümler',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
                                              ),
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 16.0, 24.0),
                                  child: StreamBuilder<List<ImsiRecord>>(
                                    stream: queryImsiRecord(
                                      queryBuilder: (imsiRecord) => imsiRecord
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ImsiRecord> listViewImsiRecordList =
                                          snapshot.data!;
                                      return ListView.builder(
                                        ...
                                        scrollDirection: Axis.vertical,
                                        itemCount:
                                            listViewImsiRecordList.length,
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewImsiRecord =
                                              listViewImsiRecordList[
                                                  listViewIndex];
                                          return Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
